...
export default class ContentfulApi {
    ...
    static async getPageContentBySlug(slug, options = defaultOptions) {
      ...
      static async getPaginatedPostSummaries(page) {
        ...
        const skipMultiplier = page === 1 ? 0 : page - 1;
        const skip =
          skipMultiplier > 0 ? paginationOptions.pageSize * skipMultiplier : 0;
    
        const variables = { limit: paginationOptions.pageSize, skip };
      ...
      static async getRecentPostList() {
        const variables = { limit: paginationOptions.recentPostsSize };
      ...
      static async callContentful(query, variables = {}, options = defaultOptions) {
        ...
        console.log(`Contentful API Token: ${CONTENTFUL_ACCESS_TOKEN}`)
